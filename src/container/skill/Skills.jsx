...
function Skills() {
  ...
  return (
    <motion.div
      className="app__skill app__flex app__container"
      id="skill"
        ...
        >
          <div>
            ...
            <p className="title-edu">
              <p className="bold-text">George Brown College</p>{" "}
              <span className="p-text">Post Graduate Diploma</span>
            </p>
          </div>
          <div>
            <p className="year bold-text">2019</p>
            <p className="title-edu">
              <p className="bold-text">Meharbanu College of Science and </p>{" "}
              <span className="p-text">
                Bachelor's Degree in Computer Appliaction
              </span>
            </p>
          </div>
          ...
          {/* <div>
            ...
            <p className="title-edu">
              <p className="bold-text">IBM </p>{" "}
              <span className="p-text">Blockchain Essentials Course</span>
            </p>
          </div> */}
        </motion.div>
      </div>
